            ...
            <Box style={{ marginLeft: 1 }}>
                <Container maxWidth="xl">
                    <Toolbar disableGutters>
                        ...
                        {/* <Box>
                            <svg style={{ paddingTop: '-20px' }} stroke="currentColor" fill="currentColor" stroke-width="0" version="1.1" viewBox="0 0 32 32" height="3rem" width="3rem" xmlns="http://www.w3.org/2000/svg">
